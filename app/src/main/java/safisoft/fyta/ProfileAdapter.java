...
public class ProfileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder( RecyclerView.ViewHolder holder, int position) {
        ...
        if(position == 0){
            ...
            ((HeaderViewMessagesHolder) holder).txtv_date_head.setText(String.valueOf("FLOS Member Since "+profile.getMember_date()));
            ...
            ((MembersProfileViewHolder) holder).txtv_date_list.setText(String.valueOf("FLOS Member Since "+profile.getMember_date()));
